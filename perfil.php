                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?php if ($_SESSION['genero'] == 'Masculino') : ?>
                                <img src="./assets/images/manicon.png" class="card-img-top" id="profile_photo" alt="porfilePhoto" width="200px" height="210px">
                                <?php endif; ?>
                                <?php if ($_SESSION['genero'] == 'Feminino') : ?>
                                <img src="./assets/images/womanicon.png" class="card-img-top" id="profile_photo" alt="porfilePhoto" width="200px" height="210px">
                            <?php endif; ?>
