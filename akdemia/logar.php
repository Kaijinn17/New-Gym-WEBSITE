...
<link rel="stylesheet" href="Login.css" media="screen">
  ...
  <body class="u-body u-xl-mode" data-lang="pt"><header class="u-clearfix u-header u-header" id="sec-cf8d"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-black u-clearfix u-section-1" id="sec-f616">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <div class="u-form u-form-1">
          <form action="login.php"  onsubmit="window.location.href='logado.php';" method="POST" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 10px;">
            ...
            <div class="u-form-checkbox u-form-group u-form-group-3">
              <input type="checkbox" id="checkbox-643c" name="checkbox" value="On">
