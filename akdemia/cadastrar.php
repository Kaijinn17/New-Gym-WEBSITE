    ...
    <section class="u-black u-clearfix u-section-1" id="sec-f616">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <div class="u-form u-form-1">
          <form action="cadastro.php" onsubmit="window.location.href='loading.php';" method="POST" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 10px;">
            ...
            <div class="u-form-date u-form-group u-form-group-5">
              <label for="date-5b56" class="u-label">Data de Nascimento</label><h3 style="color: gray; font-size: 15px; display: inline-block;">*Idade minima '14 Anos'*</h3>
            ...
            <div class="u-form-group u-form-select u-form-group-6">
              ...
              <div class="u-form-select-wrapper">
                <select id="select-c568" name="select" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
            ...
            <div class="u-align-center u-form-group u-form-submit">
              ...
              <input type="submit" name="btn-cadastrar" value="Enviar"  class="u-border-none u-btn u-btn-submit u-button-style u-custom-color-1 u-btn-1">
            </div>
          </form>
        </div>
