...
<?php
    ...
    echo "<td><a style='color:black;background-color:yellow;margin-right:30px;' href='./src/profile.php?id=".$dado['id'].'plano='.$dado['plano_novo']."'>APROVAR</a><a style='color:black;background-color:yellow;margin-right:30px;' href='./src/profile.php?id=".$dado['id']."'>REPROVAR</a></td>";
    echo "</tr>"; // fecha linha
    }
