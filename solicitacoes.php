...
<?php
    ...
    $tabela .= '<th style="margin-right:5px;">ID</th>'; // colunas do cabeçalho
    $tabela .= '<th style="margin-right:5px;>Nome</th>';
    $tabela .= '<th style="margin-right:5px;>Plano_Antigo</th>';
    $tabela .= '<th style="margin-right:5px;>Plano_Novo</th>';
